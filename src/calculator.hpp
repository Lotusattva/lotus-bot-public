...
constexpr inline const exp_t* const EXP_REQ[__MAJOR_STAGE_COUNT__][__MINOR_STAGE_COUNT__]{
    ...
    { // VIRTUOSO
        ...
        (const exp_t[]) { // LATE
            158500, 199301, 241672, 280905, 324845,
            364077
        }
    },
    { // NASCENT
        (const exp_t[]) { // EARLY
            183679, 230962, 280065, 325529, 376450,
            421915
        },
        (const exp_t[]) { // MIDDLE
            308712, 389749, 470786, 551823, 632859,
            710038, 794933
        },
        (const exp_t[]) { // LATE
            719563, 918827, 1095905, 1295213, 1472337,
            1671600, 1848723, 2047987
        }
    },
    { // INCARNATION
        (const exp_t[]) { // EARLY
